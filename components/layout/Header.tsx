    ...
    <header className="header">
      <div className='header_container'>
        <div className="nav">
          ...
          <h1 className="nav_address">{formatShortAddress((address? address : default_address) as string)}</h1>
        </div>
          ...
          <div className="search">
            <div className="input">
              ...
              <div className="input_wrap">
                ...
                <input autoComplete="off" className="input_input" type="text" disabled />
              </div>
            </div>
          </div>
          <div className='login'>
            <button className="login_button">
              <div>Log in via web3 wallet</div>
            </button>
          </div>
        </div>
      </div>
